...
import 'package:lin_261780/storecredit.dart';
...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  void _takePicture() async {
    ...
    if (_image == null) {
      ...
      print(base64Image);
      http.post("https://lintatt.com/bookhotels/php/upload_image.php", body: {
  ...
  _changeName(String name) {
    ...
    http.post("https://lintatt.com/bookhotels/php/update_profile.php", body: {
      "email": widget.user.email,
